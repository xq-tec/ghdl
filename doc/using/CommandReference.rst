...
.. option:: ast-to-json [OPTS] UNIT [ARCH]

  Dump the analyzed AST as JSONL on the standard output.

.. option:: design-to-json [OPTS] UNIT [ARCH]

  Dump the elaborated design (including AST) as JSONL on the standard output.
